...
/*$('.header').prepend('<div class="newyear"><div class="container"><p>Режим работы в праздники с 12.00 до 15.00. <a href="/4_10">Подробнее</a></p></div></div>');*/
    $('.hdhd .text-center').each(function() {
        var text = $(this).text();
        $(this).text(text.replace('течении', 'течение'));
    });
...
$('.footer_list li:nth-child(2)').find('.phone').text('+7 (812) 425-34-01');
$('.footer_list li:nth-child(4)').find('.phone').text('+7 (812) 425-34-01');

    $('body').append('<script src="/js/jquery.maskedinput.min.js"></script>');
    $('.footer_group').find('ul.footer_list:nth-child(1)').hide();
    $('.footer_group').find('ul.footer_list:nth-child(4)').hide();
    $('.footer_group').prepend('<ul class="footer_list"><li><a class="title" href="/naruzhnaya-reklama">Наружная реклама</a></li><li><a href="/obemnye_bukvy">Объемные буквы</a></li><li><a href="/svetovye-koroba">Световые короба</a></li><li><a href="/kryshnye_ustanovki">Крышные установки</a></li></ul>');

    $('.footer_group').prepend('<ul class="footer_list"><li><a class="title" href="http://anti-print.ru/interernaya-reklama">Интерьерная реклама</a></li><li><a href="http://anti-print.ru/rostovye-figury">Ростовые фигуры</a></li><li><a href="http://anti-print.ru/interernaya_pechat">Интерьерная печать</a></li><li><a href="http://anti-print.ru/postery,-svetovye-paneli,-laytboksy">Световые панели, лайтбоксы</a></li><li><a href="http://anti-print.ru/oformlenie-vitrin">Оформление витрин</a></li><li><a href="http://anti-print.ru/tantamareski">Тантамарески</a></li></ul>');
    $('.footer_list:nth-child(3)').append('<li><a href="/pechat-na-bannernoy-setke">Баннерная сетка</a></li><li><a href="/pechat-na-beklite">Бэклит</a></li><li><a href="/pechat-na-plastike-penokartone">Пластик</a></li>');
    $('.footer_list:nth-child(4)').append('<li><a href="/instaramki">Рамки инстаграм</a></li>');

    $('footer .row').append('<div class="col-xs-8"><a href="/blogi" style="color:#ffffff;text-decoration:none">Блог</a><span style="color: #fff"> &bull; </span> <a href="/vypolnennye_raboty" style="color:#ffffff;text-decoration:none">Фотогалерея</a></div><div class="col-xs-4"><div class="uppercase" style="color:#ffffff;">Сохраните чтобы не забыть:</div><div class="share_init" style="margin-top:5px"></div><div><a href="/sitemap" style="color:#ffffff;text-decoration:none">Карта сайта</a></div></div>')
    ...
    if ($('.breadcrumb').length) {
        ...
        var testik = $('.breadcrumb li:last-child').text();
        if (window.location.href == 'http://anti-print.ru/press-wall') {
            $('#ln-contacts').before('<div class="block100 ptbt30"><div class="container"><div class="row"><h6 style="font-size: 16px; font-style: italic; font-weight: bold">' + testik + ' Москва: <br><br>Адрес: Ул. Матвеевская улица, 1А, телефон: +7 (812) 425-34-01<br><br>Почтовый индекс: 121357</h6></div></div>');
        }
        else if (window.location.href == 'http://anti-print.ru/roll_up') {
            $('#ln-contacts').before('<div class="block100 ptbt30"><div class="container"><div class="row"><h6 style="font-size: 16px; font-style: italic; font-weight: bold">' + testik + ' Москва: <br><br>Адрес: Ул. Матвеевская улица, 1А, телефон: +7 (812) 425-34-01<br><br>Почтовый индекс: 121357</h6></div></div>');
        }
        else {
            $('#ln-contacts').before('<div class="block100 ptbt30"><div class="container"><div class="row"><h6 style="font-size: 16px; font-style: italic; font-weight: bold">' + testik + ' Москва: <br><br>Адрес: Ул. Матвеевская улица, 1А, телефон: +7 (812) 425-34-01<br><br>Почтовый индекс: 121357</h6></div><br> <div class="row"><h6 style="font-size: 16px; font-style: italic; font-weight: bold">' + testik + ' Санкт-Петербург (СПб): <br><br>Адрес: Чкаловский 60, телефон : 8 (812) 425-34-01<br><br>Почтовый индекс: 197022</h6></div></div>');
        }
    ...
    'VK.Widgets.Group("vk_groups1", {mode: 0, width: "280", height: "218", color1: "FFFFFF", color2: "2B587A", color3: "5B7FA6"}, 54020300);</script>'+
           ' </div>'+
            '</div>'
...
/*$('body').append(
        '<div id="insta"><div id="insta-tab" class="form-btn"><p>Оставить заявку</p><div id="insta-main">' +
        '</div></div><div id="insta-close"></div></div>'
    );*/
    ...
    $('body').append(
        ...
        '<input style="margin-right:5px;width:200px" type="text" name="bye_hunter-phone" id="bye_hunter-phone" class="form-control" placeholder="Введите Ваш номер телефона" value=""/>' +
        '</div>' +
        '<button type="submit" id="callback-button" class="btn btn-success" onclick="return false">Заказать звонок</button>' +
        '</form>' +
    ...
    $("#callback-button").click(function(eventObject) {

        var fphones = $('#bye_hunter-phone').val();
    ...
    $('#vk-tab').click(function() {
        $("#bye_hunter-phone").mask("+7 (999) 999-99-99");
    ...
    /*$('footer').append('<script type="text/javascript" src="//vk.com/js/api/openapi.js?116"></script>'+
'<div id="vk_groups1"></div>'+
'<script type="text/javascript">'+
'VK.Widgets.Group("vk_groups", {mode: 0, width: "300", height: "200", color1: "FFFFFF", color2:"2B587A", color3:"5B7FA6"}, 54020300);'+
'</script>'
                      )*/

    /*    $('.nav-list:nth-child(odd)').append('<li><a href="/informacionnye-stendy"><img src="/d/443289/d/stend6_6.jpg"><span>Информационные стенды</span></a></li>');*/
    ...
    $(document).mousemove(function(e) {
        ...
        /*if(e.pageY <= 5) {
            ...
            var bye_hunter_modal = 
                '<div id="bye_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">'+
                  '<div class="modal-dialog">'+
                    '<div class="modal-content">'+
                      '<div class="modal-header">'+
                        '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
                        '<h4 class="modal-title">У вас остались вопросы? Давайте мы перезвоним Вам</h4>'+                       
                      '</div>'+
                      '<div class="modal-body">'+
                        '<form class="form-inline" method="POST">'+
                              '<div class="form-group">'+
                                '<label style="margin-right:5px">Введите ваш телефон:</label>'+
                                '<input style="margin-right:5px;width:200px" type="text" name="bye_hunter-phone" id="bye_hunter-phone" class="form-control" placeholder="телефон" value=""/>'+
                              '</div>'+
                              '<button type="submit" id="callback-button" class="btn btn-success" onclick="return false">Жду звонка -></button>'+
                        '</form>'+
                        '<p style="margin-top: 20px">Наш оператор позвонит Вам и проконсультирует по всем вопросам!</p>'+
                      '</div>'+
                    '</div>'+
                  '</div>'+
                '</div>';

            if(!$('#bye_modal').length && !$.cookie('bye_hunter_antiprint')) {
                $('body').append(bye_hunter_modal);
                $('#bye_modal').modal('show');
            }           
            

            $('#bye_modal').on('shown.bs.modal', function (e) {
                $.cookie('bye_hunter_antiprint', 1, { expires: 3 });
                ...
                $("#callback-button").click(function(eventObject){
                    ...
                    if( fphones ) { 
                        ...
                        $.post("/callback", { 'fphones': fphones, 'ref': ref, 'loc':loc, 'city':ct, 'promo':promo, 'brs':brs }, function(data){
...
$(function() {
    ...
    $('img .highslide-image').prepend('<div class="closebutton"></div>');
...
var fsrc = $('#modal-callback #f-source').val();
    ...
    var manualuploader1 = $('#manual-fine-uploader1').fineUploader({
        request: {
            endpoint: '/server/handleUploads'
        },
        validation: {
        ...
        callbacks: {
            onAllComplete: function(successful, failed) { //массивы
                ...
                $('.forma #uprogress').html('<img src="/fineuploader/loading.gif" alt="loading"/> Отправляем данные...');

                var fname = $('.forma #f-name').val();
                var fphones = $('.forma #f-phones').val();
                var femail = $('.forma #f-email').val();
                var ref = escape(document.referrer);
                var loc = escape(document.location);
                var files = $(".forma #result-fl").html();
                var ct = $("#g-reaal-city").html();
                var promo = $(".roistat-promo").html();
                ...
                $.post("/sender", {
                    ...
                    $('.forma #sender').removeAttr('disabled');

                    if (data.error) { //выводим ошибки
                        $('.forma #uprogress').html('').hide();
                        $('.forma .qq-upload-list .qq-upload-success').addClass('qq-upload-fail').removeClass('qq-upload-success');
                        alert(data.error);
                    } else {
                        $('.forma #uprogress').html('');
                        //alert(data.success);
                        document.location = '/spasibo';
                    }
                }, "json");
            ...
            onSubmit: function(id, fileName) {
                fileCount1++;
                if (fileCount1 > fileLimit1) {
                    $('#manual-fine-uploader1 .qq-upload-button').hide();
                    $('#manual-fine-uploader1 .qq-upload-drop-area').hide();
                    return false;
                }
            },
            onCancel: function(id, fileName) {
                fileCount1--;
                if (fileCount1 <= fileLimit1) {
                    $('#manual-fine-uploader1 .qq-upload-button').show();
                }
            },
            onComplete: function(id, fileName, responseJSON) {
                if (responseJSON.success) {
                    addedFiles1++;
                    if (addedFiles1 >= fileLimit1) {
                        $('#manual-fine-uploader1 .qq-upload-button').hide();
                        $('#manual-fine-uploader1 .qq-upload-drop-area').hide();
                    }
                    var result_fl = $(".forma #result-fl").html();
                    $(".forma #result-fl").html(result_fl + '||' + responseJSON.data_url);
                }
            }
        },
        template: "qq-template-manual-noedit1",
        autoUpload: false
    });
    /*var manualuploader2 = $('#manual-fine-uploader2').fineUploader({
                request: {
                    endpoint: '/server/handleUploads'
                },
                validation: {
                ...
                callbacks: {
                    ...
                    var brs = "== " + getBrowser();
                        ...
                        //отправка формы
                        $.post("/sender", { 'fname': fname, 'fphones': fphones, 'femail': femail, 'ref': ref, 'loc':loc, 'city':ct, 'promo':promo, 'files':files, 'brs':brs  }, function(data){
                    ...
                    onSubmit: function(id, fileName) {
                        fileCount1 ++;
                        if(fileCount1 > fileLimit1) {
                            $('#manual-fine-uploader2 .qq-upload-button').hide();
                            $('#manual-fine-uploader2 .qq-upload-drop-area').hide();
                            return false;
                        }
                    },
                    onCancel: function(id, fileName) {
                        fileCount1 --;
                        if(fileCount1 <= fileLimit1) {
                            $('#manual-fine-uploader2 .qq-upload-button').show();
                        }
                    },
                    onComplete: function(id, fileName, responseJSON) {
                        if (responseJSON.success) {
    ...
    $('#sender').click(function() {
        ...
        if (!$('.forma #f-phones').val()) {
            alert("Вы не заполнили обязательное поле: Телефон(ы)");
            return;
        }

        $('.forma #sender').attr('disabled', true);

        //загрузка файлов
        if ($('.forma .qq-upload-list').html()) {
            $('.forma #uprogress').html('<img src="/fineuploader/loading.gif" alt="loading"/> Загружаем файлы...');
            manualuploader1.fineUploader('uploadStoredFiles');
        } else {
...
ymaps.ready(function() {
    ...
    var ucenter = [55.70446327734321,37.480938500000015];
    var uzoom = 10;
    var adres = 'Москва, Ул. Матвеевская улица, 1А';
    var myMap;
    var tcity = 0;

    //$.cookie('select-city', 1);

    /*  
    var url = document.location.href;
    var regV1 = /pechat\-bannerov\.anti\-print\.ru/gi;
    var result1 = url.match(regV1);
    var regV2 = /roll\-up\-stendy\.anti\-print\.ru/gi;
    var result2 = url.match(regV2);
    var regV3 = /kupit\-press\-wall.anti\-print\.ru/gi;
    var result3 = url.match(regV3); 
    */
    if ($.cookie('select-city') == 2 /* || result1 || result2 || result3*/ ) {

        var tcity = 'Москва, Ул. Матвеевская улица, 1А';
        var city = 'Москва';

    } else if ($.cookie('select-city') == 1) {

        var tcity = 'Санкт-Петербург, Чкаловский проспект д. 60';
    ...
    if (!tcity) {
        ...
        var dolgota = ymaps.geolocation.longitude; //longitude - долгота;
        var shirota = ymaps.geolocation.latitude; //latitude - широта;
        var zoom = ymaps.geolocation.zoom; //zoom - масштаб (если доступен);

    }

    url_href = window.location.href;

    if (url_href.indexOf("lp.press-moskva") > -1) {
        var city = 'Москва';
    }

    if (url_href.indexOf("lp.roll-up-moskva") > -1) {
        var city = 'Москва';
    }

    if (url_href.indexOf("lp.press-spb") > -1) {
        var city = 'Санкт-Петербург';
    }

    if (url_href.indexOf("lp.roll-up-spb") > -1) {
        var city = 'Санкт-Петербург';
    }
    ...
    if (city) {
        ...
        $("#g-reaal-city").html(city);

        if (city == 'Санкт-Петербург') {
            $('body').append('<script>window.roistatPhonePrefix = "7812"; window.roistatCallTrackingRefresh();</script>');
            if (url_href.indexOf("lp.press-spb") > -1) {
                    //$('body').append('<script>window.roistatPhonePrefix = "7812";</script>');
                    $(".g-phone").html('<span class="glyphicon glyphicon-earphone"> </span><span class="roistat-phone"> 8 (812) 425-34-01</span>');
                    $(".contacts .phone span").html('<span class="roistat-phone">8 (812) 425-34-01</span>');
            }

            else if (url_href.indexOf("lp.roll-up-spb") > -1) {
                    //$('body').append('<script>window.roistatPhonePrefix = "7812";</script>');
                    $(".g-phone").html('<span class="glyphicon glyphicon-earphone"> </span><span class="roistat-phone"> 8 (812) 425-34-01</span>');
                    $(".contacts .phone span").html('<span class="roistat-phone"> 8 (812) 425-34-01</span>');
            }
            else {
              $(".g-phone").html('<span class="glyphicon glyphicon-earphone"></span><span class=""> 8 (812) 425-34-01 </span>'); //8 (495) <b>215-24-18</b>
                $(".contacts .phone span").html('<span class=""> 8 (812) 425-34-01</span>'); //html('8 (495) 215-24-18');  
            }
            $(".contacts .address span").html('Чкаловский проспект д. 60');
            $(".g-city").html(
                '<span class="dropdown-toggle" id="dropdownsity" data-toggle="dropdown">Санкт-Петербург</span>' +
                '<ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownsity">' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(2)">Москва</a></li>' +
                '<li role="presentation" class="disabled"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(1)">Санкт-Петербург</a></li>' +
                '<li role="presentation" class="divider"></li>' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(0)">Другой город</a></li>' +
                '</ul>'
            );
            $(".span-link-map").html(' <a class="fancybox" href="#bmap"><i class="glyphicon glyphicon-map-marker"></i> карта</a>');

            $("#bmap #padres").html(
                '<b>Санкт-Петербург</b><br />' +
                'офис : Чкаловский проспект д. 60<br />' +
                'тел. <span class="roistat-phone">8 (812) 425-34-01</span><br />' +
                'zakaz@6481378.ru<br />'
            );
            ...
            adres = 'Санкт-Петербург, Чкаловский проспект д. 60';
            /*if(shirota && dolgota) ucenter = [shirota,dolgota];
            else ucenter = 0;*/
            ucenter = [59.96862826, 30.30265350];
            uzoom = zoom;
            ...
            $('body').append('<script>window.roistatPhonePrefix = "7495"; window.roistatCallTrackingRefresh();</script>');
            if (url_href.indexOf("lp.press-moskva") > -1) {
                if (url_href.indexOf("lp.roll-up-moskva") > -1) {
                    //$('body').append('<script>window.roistatPhonePrefix = "7495";</script>');
                    $(".g-phone").html('<span class="glyphicon glyphicon-earphone"></span><span class="roistat-phone"> 8 (812) <b>425-34-01</b> </span>'); //8 (495) <b>215-24-18</b>
                    $(".contacts .phone span").html('<span class="roistat-phone"> 8 (812) <b>425-34-01</b></span>'); //html('8 (495) 215-24-18');
                }
            } else if (url_href.indexOf("lp.roll-up-moskva") > -1) {
                if (url_href.indexOf("lp.press-moskva") > -1) {
                    //$('body').append('<script>window.roistatPhonePrefix = "7495";</script>');
                    $(".g-phone").html('<span class="glyphicon glyphicon-earphone"></span><span class="roistat-phone"> 8 (812) <b>425-34-01</b> </span>'); //8 (495) <b>215-24-18</b>
                    $(".contacts .phone span").html('<span class="roistat-phone"> 8 (495) <b>215-24-18</b></span>'); //html('8 (495) 215-24-18');
                }
            } else {
                $(".g-phone").html('<span class="glyphicon glyphicon-earphone"></span><span class=""> 8 (812) <b>425-34-01</b> </span>'); //8 (495) <b>215-24-18</b>
                $(".contacts .phone span").html('<span class=""> 8 (812) <b>425-34-01</b></span>'); //html('8 (495) 215-24-18');
            }




            $(".contacts .address span").html('Ул. Матвеевская улица, 1А');
            $(".g-city").html(
                '<span class="dropdown-toggle" id="dropdownsity" data-toggle="dropdown">Москва</span>' +
                '<ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownsity" style="right:-10px">' +
                '<li role="presentation" class="disabled"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(2)">Москва</a></li>' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(1)">Санкт-Петербург</a></li>' +
                '<li role="presentation" class="divider"></li>' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(0)">Другой город</a></li>' +
                '</ul>'
            );
            ...
            $("#bmap #padres").html(
                '<b>Москва</b><br />' +
                'офис : Ул. Матвеевская улица, 1А<br />' +
                'тел.<span class=""> +7 (812) 425-34-01</span><br />' +
                'zakaz@6481378.ru<br />'
            );

            var ucenter = [55.71108946, 37.43619767];
            uzoom = zoom;
            ...
            $('.roistat-phone').html(' +7 (812) 425-34-01');
            $(".g-city").html(

                '<span class="dropdown-toggle" id="dropdownsity" data-toggle="dropdown">' + city + '</span>' +
                '<ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownsity">' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(2)">Москва</a></li>' +
                '<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(1)">Санкт-Петербург</a></li>' +
                '<li role="presentation" class="divider"></li>' +
                '<li role="presentation" class="disabled"><a role="menuitem" tabindex="-1" href="#" onclick="selcity(0)">Другой город</a></li>' +
                '</ul>'
            );
            //$(".after-phone").html('Звонок по РФ-бесплатно!');


            $(".contacts .cntkt3").remove();
            $('#map-contacts').hide();
            $('.letter').addClass('col-xs-offset-3');
            $(".contacts .cntkt1,.contacts .cntkt2").addClass("col-xs-6").removeClass('col-xs-4');
    ...
    if (!ucenter) {
        ymaps.geocode(city, {
            ...
            var firstG = res.geoObjects.get(0);
            // Создаем карту с нужным центром.
            ucenter = firstG.geometry.getCoordinates();
            ...
            var objects = ymaps.geoQuery(ymaps.geocode(adres, {
                    results: 1
                }))
                .addToMap(myMap);
            var balloonsn = ['<b>Anti-print.ru</b>'];
            var balloons = ['<b>Рекламная Мастерская</b></br />' + adres];

            i = 0;
            // Все операции асинхронные, поэтому следует дождаться готовности данных. 
            objects.then(function() {
                objects.each(function(object) {
                    object.properties.set('balloonContentBody', balloons[i++]).set('iconContent', balloonsn[0]);
                    object.options.set('preset', 'twirl#redStretchyIcon');
                });
            });
        ...
        afterShow: function() {
            ...
            if (tcity) {
                ...
                ymaps.geocode(tcity, {
                    ...
                    // Создаем карту с нужным центром.
                    ucenter = firstGeoObject.geometry.getCoordinates();

                    myMapf = new ymaps.Map('map', {
                        center: ucenter,
                        zoom: 12,
                        behaviors: ['default', 'scrollZoom']
                    });

                    myMapf.controls.add('smallZoomControl').add('typeSelector');
                    myMapf.container.fitToViewport();

                    var objects = ymaps.geoQuery(ymaps.geocode(adres)).addToMap(myMapf);
                    var balloons = ['<b>Рекламная Мастерская</b></br />' + adres],
                        i = 0;
...
http://xiper.net/collect/js-plugins/browser-detect/browser-name-and-version                     
*/
